...
class _LoginPageState extends State<LoginPage> {
  ...
  void loginUser() async {
    ...
    final selectedUsertype = usertypeKey.currentState?.getSelectedItems.toString() ?? 'Admin';

    String res = await Authentication().login(
        userType:selectedUsertype, userId:_emailController.text.trim(),password: _passwordController.text.trim());
    if (res == 'success') {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomButton(onpress: loginUser, isLoading: _isLoading),
