...
class RecoverableSattelmentCases extends StatefulWidget {
  const RecoverableSattelmentCases({super.key});

  @override
  State<RecoverableSattelmentCases> createState() => _RecoverableSattelmentCasesState();
}

class _RecoverableSattelmentCasesState extends State<RecoverableSattelmentCases> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('SETTLEMENT COMMISION CASES')),
      body: Expanded(
        child: Column(
          children: [
             InkWell(
              ...
              onTap:(){
                ExcelDonwloadOption().exportToExcel(myData,'SETTLEMENT COMMISION CASES');
              },
            ),
