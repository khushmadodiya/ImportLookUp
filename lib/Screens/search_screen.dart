...
class _SearchScreenState extends State<SearchScreen> {
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        generalProvider.updateSearchQuery(value);
                      },
                    ),
                  ),
                ),
  ...
  void getData() async {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if(asseserProvider.mainCaseDataForSearching.isEmpty ){
        if(user.userType == USERTYPE[0]) {
          await asseserProvider.getMainCasesInformationForSearching(
              formation: FORMATION[0], isAdmin: true);
        }
        else{
          await asseserProvider.getMainCasesInformationForSearching(
              formation: user.formation, isAdmin: false);
        }
      }
