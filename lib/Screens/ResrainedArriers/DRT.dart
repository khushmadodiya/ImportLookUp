...
class DRTPage extends StatefulWidget {
  const DRTPage({super.key});

  @override
  State<DRTPage> createState() => _DRTPageState();
}

class _DRTPageState extends State<DRTPage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('DRT CASES')),
      body: Expanded(
        child: Column(
          children: [
             InkWell(
              ...
              onTap:(){
                ExcelDonwloadOption().exportToExcel(myData,'DRT CASES');
              },
            ),
