...
class OLPage extends StatefulWidget {
  const OLPage({super.key});

  @override
  State<OLPage> createState() => _OLPageState();
}

class _OLPageState extends State<OLPage> {
  @override
  void initState() {
    super.initState();
        ...
        child: Column(
          children: [
             InkWell(
              ...
              onTap:(){
                ExcelDonwloadOption().exportToExcel(myData,'OL CASES');
              },
            ),
