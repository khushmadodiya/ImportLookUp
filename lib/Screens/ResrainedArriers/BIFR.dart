...
class BIFRPage extends StatefulWidget {
  const BIFRPage({super.key});

  @override
  State<BIFRPage> createState() => _BIFRPageState();
}

class _BIFRPageState extends State<BIFRPage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('BIFR CASES')),
      body: Expanded(
        child: Column(
          children: [
             InkWell(
              ...
              onTap:(){
                ExcelDonwloadOption().exportToExcel(myData,'BIFR CASES');
              },
            ),
