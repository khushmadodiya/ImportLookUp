...
class NCLTPage extends StatefulWidget {
  const NCLTPage({super.key});

  @override
  State<NCLTPage> createState() => _NCLTPageState();
}

class _NCLTPageState extends State<NCLTPage> {
  @override
  void initState() {
    super.initState();
        ...
        child: Column(
          children: [
             InkWell(
              ...
              onTap:(){
                ExcelDonwloadOption().exportToExcel(myData,'NCLT CASES');
              },
            ),
