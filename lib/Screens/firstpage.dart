...
class AppealPeriodNotOver extends StatefulWidget {
  const AppealPeriodNotOver({super.key});

  @override
  State<AppealPeriodNotOver> createState() => _AppealPeriodNotOverState();
}

class _AppealPeriodNotOverState extends State<AppealPeriodNotOver> {
  ...
  void adddetail() async {
      ...
      String res=  await AddAsesse().addDetails(asseserDetails,_oioNoDateController.text.toString());
     if(res=="s") {
        ...
        child: Column(
          children: [
            ...
            buildRow(
              ...
              _effortsMadeRemarksController,
              'Stay order no. & date',
              'Efforts Made/Remarks',
            ),
            ElevatedButton(
              onPressed: () {adddetail();},
